...
const Hero = () => (
    ...
    ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-cover w-full'>
          ...
          <div className='ss:flex hidden md:mr-4 mr-0 hover:scale-105'>
            <GetSarted /> 
          </div>
        </div>
      ...
      <div className={`ss:hidden ${styles.flexCenter} hover:scale-105`}> 
        <GetSarted />
      </div>
    </section>
  )
